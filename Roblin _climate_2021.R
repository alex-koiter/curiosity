...
# Find station(s)
## Not sure where the closest station with current data is located so I search with coords and ends_earliest
stations_search(coords = c(50.781, -101.284), interval = "day", ends_earliest = 2021)

# Download data from ECCC
data <- weather_dl(station_ids = "27119", start = "1996-10-01", interval = "day")
min(data$date) # 1996 is not a full year
...
ggsave(plot = p1, filename = "Roblin water year precip.png", width = 230, height = 200, units = "mm", dpi = 600)
...
ggsave(plot = p2, filename = "Roblin growing precip.png", width = 230, height = 200, units = "mm", dpi = 600)
...
ggsave(plot = p3, filename = "Roblin GDD.png", width = 230, height = 200, units = "mm", dpi = 600)
