...
# Find station(s)
stations_search(coords = c(50.385546, -98.675199), interval = "day", ends_earliest = 2021)

# Download data from ECCC
data <- weather_dl(station_ids = "3775", start = "1973-10-01", interval = "day") 
...
ggsave(plot = p1, filename = "Beaver water year precip.png", width = 230, height = 200, units = "mm", dpi = 600)
...
ggsave(plot = p2, filename = "Beaver growing precip.png", width = 230, height = 200, units = "mm", dpi = 600)

# No temp data available