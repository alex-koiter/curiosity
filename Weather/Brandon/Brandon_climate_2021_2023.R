...
data <- weather_dl(station_ids = "50821", start = "2012-10-01", end = "2023-09-30", interval = "day") %>%
...
p1 <- ggplot(data = avg, aes(y = median , x = new_date)) +
  ...
  geom_line(data = filter(water_year, water_year == 2023), aes(y = cum_precip , x = new_date, colour = "2023"), size = 1.5) +
  scale_colour_manual(name='', 
                      values = c("1960-2020 Median" = "black", "2021" = "red", "2022" = "blue", "2023" = "darkgreen")) +
...
ggsave(plot = p1, filename = "./Weather/Brandon/Brandon water year precip 2021_2023.png", width = 230, height = 200, units = "mm", dpi = 600)
